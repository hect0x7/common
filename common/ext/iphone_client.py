...
from common import Iterable, Tuple, Optional, \
    Response, Postman, FixUrlPostman, \
    of_file_name, multi_thread_launcher
...
class IphoneClient:
    ...
    @staticmethod
    def default_call_back(monitor: MultipartEncoderMonitor,
    ...
    def upload_file(self,
        ...
        if is_upload_success is False:
            raise AssertionError(f'文件上传失败，响应文本:"{resp.text}"')
